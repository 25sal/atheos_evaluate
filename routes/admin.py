...
from app.utils.admin import import_reservations, gen_passwords, add_atheos_users, create_random_projects, update_atheos_projects, create_prj_dirs, restrict_atheos_acl
...
def admin_list_projects():
    ...
    for project in projects:
        content += "<row id='"+str(project[0])+"'><cell><![CDATA["+str(project[0])+"]]></cell><cell><![CDATA["+str(project[1])+"]]></cell>" \
                   ...
                   "<cell><![CDATA["+str(project[4])+"]]></cell></row>"
