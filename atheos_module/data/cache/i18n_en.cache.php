...
return array(
	...
	"paste" => "Paste",
	"extract" => "Extract",
	"extract_success" => "Successfully extracted archive.",
	"extract_unable" => "Unable to extract archive.",
	"extract_noOpen" => "Unable to open archive.",
	"extract_noZip" => "PHP ZipArchive not installed or enabled.",
	"extract_noPhar" => "PHP PharData not installed or enabled.",
	"extract_noRar" => "PHP Rar Open not installed or enabled.",
	"extract_noDecomp" => "Unable to decompress gzip archive.",
	"extract_unrecognized" => "Unsupported archive type.",
	"duplicate" => "Duplicate",
	"duplicate_name" => "Enter new name:",
	"duplicate_file" => "File Duplicated",
	"duplicate_folder" => "Folder Duplicated",
	"preview" => "Preview",
	"outsideWorkspace" => "File located outside of workspace.",
	"cancel" => "Cancel",
	"clear" => "Clear",
	"name" => "Name",
	...
	"account_download" => "Download Bulk Template",
	"account_upload" => "Upload Bulk Accounts",
	"username" => "Username",
	...
	"git_error_noPath" => "Missing path.",
	"git_error_noRepoFileMsg" => "Missing repo, file or message.",
	"git_error_noRepoFile" => "Missing repo or file.",
	"git_error_noPathUrl" => "Missing path or URL.",
	"git_error_noTypeRepoRemoteBranch" => "Missing type, repo, remote or branch.",
	"git_error_noRepoType" => "Missing repo or type.",
	"git_error_invalidAction" => "Invalid action.",
	"git_init" => "Git Init",
	...
	"git_commit" => "Commit",
	"git_commit_message" => "Enter commit message here (optional to amend)...",
	"git_commit_success" => "Changes commited.",
	"git_commit_failed" => "Changes could not be committed.",
	"git_amend" => "Amend",
	"git_amend_success" => "Changes commited with amend option.",
	"git_amend_failed" => "Changes could not be committed with amend option.",
	...
	"git_objects_status" => "Status",
	"git_objects_file" => "File",
	"git_objects_actions" => "Actions",
	"git_objects_actions_diff" => "Diff",
	"git_objects_actions_undo" => "Undo",
	"overview" => "Overview",
	"log" => "Log",
	"transfer" => "Transfer",
	"configure" => "Configure",
